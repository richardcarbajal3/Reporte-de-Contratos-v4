              ...
              <TableBody>
                {contracts.map((row) => (
                  <TableRow key={row.key} className="group hover:bg-muted/30 transition-colors">
                    <TableCell className="font-medium font-mono text-xs">{row.key}</TableCell>
                    <TableCell className="text-xs text-muted-foreground max-w-[200px] truncate" title={row.description}>
                      {row.description}
                    </TableCell>
